...
public class PatientInformation {
    public static void main(String[] args) {
                ...
                long personalPhoneNum=scan.nextLong();
                ...
                System.out.println("Address: "+street+", "+city+", "+state+" "+zipcode); System.out.println("Contacts: work phone number - "+workPhoneNumber+", personal phone number - "+personalPhoneNum+", email: "+email);
